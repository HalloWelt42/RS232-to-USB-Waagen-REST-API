...
const de = {
  ...
  protocol: {
    ...
    company: 'Firma',
    location: 'Standort',
    method: 'Verfahren / Method-ID',
    lastCal: 'Letzte Kalibrierung',
    printedAt: 'Gedruckt am',
    scaleModel: 'Waage',
    scaleSpec: 'Spezifikation',
    hardwareLive: 'Hardware live',
    yes: 'Ja',
    no: 'Nein',
    notLegalForTrade: 'Hinweis: nicht eichfähige Anzeige — keine Verwendung im eichpflichtigen Verkehr.',
    signOperator: 'Unterschrift Bediener',
    signSecond: 'Zweite Unterschrift / 4-Augen-Prüfung',
    hashLabel: 'SHA-256 (Tamper-Evidence)',
    printHint: 'Felder ausfüllen, dann „Drucken" — Browser-Druck-Dialog mit allen Sichtbarkeit-Toggles.',
    doPrint: 'Drucken',
    exportHint: 'Format auswählen, Vorschau prüfen, Datei herunterladen.',
    doDownload: 'Herunterladen',
    saveHint: 'Direkt-Speichern in einem der vier Formate. Datei landet im Browser-Download-Ordner.',
    saveMeta: 'Tamper-Evidence-Hash der aktuellen Liste: %hash',
  },
  iconPicker: {
