...
const en = {
  ...
  protocol: {
    ...
    colValue: 'Value',
    colDiff: 'Difference',
    printHint: 'Print preview below is exactly what lands on paper. "Print" opens the browser dialog.',
    doPrint: 'Print',
    exportHint: 'Pick a format, check the preview, download the file.',
    doDownload: 'Download',
    saveHint: 'Direct save in one of the formats. File lands in your browser download folder.',
    waageFormatHint: '(own app format, JSON, complete)',
  },
  iconPicker: {
