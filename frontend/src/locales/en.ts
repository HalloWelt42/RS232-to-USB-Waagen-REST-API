...
const en = {
  ...
  commands: {
    ...
    unitDone: 'Unit switched',
    light: 'Backlight',
    lightTooltip: 'Display backlight on/off (RS232: ESC u)',
    lightDone: 'Backlight toggled',
    copyValueTitle: 'Copy value to clipboard',
    copyValueAria: 'Copy value',
    closeWindow: 'Close window',
    closeHelpWindow: 'Close help window',
    contactMailTitle: 'Copy email / open mail client',
    contactMailAria: 'Email address',
  },
  status: {
    live: 'Live',
  ...
  live: {
    ...
    overload: 'OVERLOAD',
    overloadHint: 'The scale reports a load above maximum. Remove load, the display will recover.',
  },
  donate: {
    title: 'Support Waage',
    intro:
  ...
  protocol: {
    ...
    location: 'Location',
    method: 'Method',
    lastCal: 'Last calibration',
    printedAt: 'Printed at',
    scaleModel: 'Scale',
    scaleSpec: 'Specification',
    hardwareLive: 'Hardware live',
    yes: 'Yes',
    no: 'No',
    notLegalForTrade: 'Note: not a legal-for-trade indicator — must not be used in regulated metrology.',
    signOperator: 'Operator signature',
    signSecond: 'Second signature / 4-eyes check',
    hashLabel: 'SHA-256 (tamper evidence)',
    printHint: 'Fill the header fields, then "Print" — browser print dialog with all visibility toggles.',
    doPrint: 'Print',
    exportHint: 'Pick a format, check the preview, download the file.',
    doDownload: 'Download',
    saveHint: 'Direct save in one of four formats. File lands in your browser download folder.',
    saveMeta: 'Tamper evidence hash of the current list: %hash',
  },
  iconPicker: {
